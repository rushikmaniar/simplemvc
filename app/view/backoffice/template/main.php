<!DOCTYPE html>
<html lang="en">
<!-- Load script.php css,js -->
<?php $this->load->view('backendwork/template/script.php'); ?>
    <body class="nav-md">
        ...
        <div class="container body">
            ...
            <!-- Left Sidebar  -->
            <?php $this->load->view('backendwork/template/sidebar.php'); ?>
            <!-- End Left Sidebar  -->
        </div>


            <!-- header section starts  -->
                <?php $this->load->view('backendwork/template/header.php'); ?>
            <!-- End header header -->
            ...
            <!-- footer starts -->
                <?php $this->load->view('backendwork/template/footer.php'); ?>
            <!-- End footer -->

            <!-- loading footerscript js -->
                <?php $this->load->view('backendwork/template/footerScript.php'); ?>
            </div>
        </div>
    </body>
</html>